...
echo ADD TABLE
psql --set ON_ERROR_STOP=on -U dronepass -d dronepasstest -f ./data/drone_pass_create.sql
echo ADD TEST DATA
psql --set ON_ERROR_STOP=on -U dronepass -d dronepasstest -f ./data/test_data_create.sql